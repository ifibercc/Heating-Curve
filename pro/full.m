...
[cmWan, cSqWan] = DiscreteFrechetDist(wanTempFinal,outTempFinal);
[cmXing, cSqXing] = DiscreteFrechetDist(xingTempFinal,outTempFinal);
%% 绘图
plot(data1(:,13),wanTempFinal)
hold on
plot(data1(:,13),xingTempFinal)
plot(data1(:,13),outTempFinal) 
